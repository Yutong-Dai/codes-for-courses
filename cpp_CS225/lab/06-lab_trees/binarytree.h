...
class BinaryTree
{
  ...
  private:
    ...
    /**
         * Private helper function for the public isOrderedRecursive.
         * @param subRoot The current node in the recursion
         */
    bool isOrderedRecursive(const Node *subRoot) const;

    /**
         * Private helper function for the public isOrderedRecursive's helper function isOrderedRecursive(const Node *subRoot) .
         * @param subRoot The current node in the recursion
         */
    ...
    /**
         ...
         * @param elem The element to insert
         */
    void getPaths(const Node *subRoot, vector<T> &path, vector<vector<T>> &paths) const;
    ...
    int sumDistances(const Node *subRoot, int &curDepth) const;
};
