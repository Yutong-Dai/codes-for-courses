'''
File: perfp.py
Modified based on the file in <https://github.com/Jvanschoubroeck/performance-profiles-in-python/blob/master/optperfprofpy.py>
File Created: 2020-03-16 20:23
Last Modified: 2020-03-17 22:34
--------------------------------------------
Description:
'''
import warnings
...
if __name__ == "__main__":
    data_large = pd.read_csv('profile.txt', delim_whitespace=True)  # from polyps
    data_small = pd.read_csv('_profile.txt', delim_whitespace=True)  # from my laptop
    df = pd.concat([data_small[0:144], data_large[0:63]])
