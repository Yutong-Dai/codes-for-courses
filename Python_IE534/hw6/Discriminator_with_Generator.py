'''
File:  Discriminator_with_Generator.py
Author: Yutong Dai (rothdyt@gmail.com)
File Created: Thursday, 2018-10-25 17:25
Last Modified: Sunday, 2018-10-26 14:25
--------------------------------------------
Desscription: Train a Discriminator(CNN) with the Generator(CNN).
'''
import torch
import torchvision
...
for epoch in range(0, num_epochs):
    ...
    for batch_idx, (X_train_batch, Y_train_batch) in enumerate(trainloader):
        ...
        if((batch_idx % gen_train) == 0):
            ...
            # here, G try to maxmize gen_source
